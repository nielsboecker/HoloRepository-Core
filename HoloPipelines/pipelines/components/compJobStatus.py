...
def updateStatus(jobID, jobStatus):#TODO rename this comp to just http request? and rename this function to updateJobStatus
...
if __name__ == "__main__":
    ...
    print("You shouldn't be able to run this component directly after we're done testing")#TODO look at this too pls
