...
def test_pipelines_dicom2glb():
	...
	assert os.path.isfile(fileHand.glbPath + "3_Axial_CE.glb")
...
def test_pipelines_lungDicom2glb():
	...
	assert os.path.isfile(fileHand.glbPath + "3_Axial_CE_lungSegmented.glb")
...
def test_pipelines_nifti2obj():
	...
	assert os.path.isfile(fileHand.objPath + "1103_3_glm.obj")
...
def test_pipelines_nifti2glb():
	...
	assert os.path.isfile(fileHand.glbPath + "1103_3_glm.glb")
