...
class Holoblob:
    ...
    def create_container(self, container_name, public_access=False):
        ...
        try:
            ...
            self.service.create_container(container_name, public_access=access)
    ...
    def upload(self, container_name, file_path):
        ...
        try:
            ...
            self.service.create_blob_from_path(container_name, local_file_name, file_path)
            print(f"{file_path} uploaded to {container_name} as {local_file_name}")
            print(f"Access-URL: {self.service.make_blob_url(container_name, local_file_name)}")
    ...
    def list_blobs(self, container_name):
        ...
        try:
            generator = self.service.list_blobs(container_name)
